<template>
  <div class="sidebar-menu">
    ...
    <ul>
      <li class="sidebar-menu__category active">Салаты и закуски</li>
      <li class="sidebar-menu__category">Паста</li>
      <li class="sidebar-menu__category">Суши-бар</li>
      <li class="sidebar-menu__category">Горячие блюда</li>
    </ul>
  </div>
</template>
