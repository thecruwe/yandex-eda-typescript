  ...
  <div class="header">
    ...
    <div class="header__address">
      <div class="header__address-action">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="header__address-svg">
          <path
              d="M18.529 6.125a.5.5 0 0 0-.654-.654L3.307 11.565a.5.5 0 0 0-.307.461v.196a.5.5 0 0 0 .32.466l5.76 2.232 2.223 5.76a.5.5 0 0 0 .467.32h.195a.5.5 0 0 0 .461-.307L18.53 6.125Z"
    ...
    <div class="header__action-switch-language">
      <svg xmlns="http://www.w3.org/2000/svg" class="header__action-switch-language-svg">
    ...
    <div
        ...
        v-if="cart.length"
    >
      <svg xmlns="http://www.w3.org/2000/svg" class="header__total-price-svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
