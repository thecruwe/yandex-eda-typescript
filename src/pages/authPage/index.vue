  ...
  <div class="auth">
    <div class="auth__content">
      ...
      <div class="auth__logo">
        ...
        <div class="auth__content-select">
          <div
              class="auth__content-select-sign-up"
          ...
          <div
              class="auth__content-select-sign-in"
              @click="switchMethodOfSign"
              :class="{active : !isActiveMethodOfSign}"
          >
            Вход
        ...
        <div
          ...
          <input
              v-model="inputEmail"
              class="auth__content-input-email"
              placeholder="Введите почту"
          >
          <input
              v-model="inputPassword"
              class="auth__content-input-password"
      ...
      <div
          class="auth__content-action-sign-up"
          v-if="isActiveMethodOfSign"
          @click="signUp"
      >
        Зарегистрироваться
      ...
      <div
          class="auth__content-action-sign-in"
          v-if="!isActiveMethodOfSign"
          @click="signIn"
      >
        Войти
